...
```html
<ss-icon icon="chat-bubble-left-right"></ss-icon>
```

### Dengan tag ikon

```html
<i class="ss ss-chat-bubble-left-right"></i>    
```

### Dengan ketebalan garisan tersuai

```html
<ss-icon icon="chat-bubble-left-right" thickness="1.2"></ss-icon>
```
...
const svg = icons['chat-bubble-left-right'];
console.log(svg);
```
...
| Ciri | Nilai |
|------|-------|
| **Nama** | Chat Bubble Left Right |
| **Slug** | `chat-bubble-left-right` |
| **Tag** | `conversation`, `exchange`, `discussion`, `interview`, `forum`, `chat-bubble-left-right` |
