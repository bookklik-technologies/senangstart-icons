...
```html
<ss-icon name="chart-bar"></ss-icon>
```

### With custom size

```html
<ss-icon name="chart-bar" size="32"></ss-icon>
```

### With custom color

```html
<ss-icon name="chart-bar" color="#3b82f6"></ss-icon>
```

### With custom stroke width

```html
<ss-icon name="chart-bar" stroke="2"></ss-icon>
```
...
| **Name** | Chart Bar |
| **Slug** | `chart-bar` |
| **Tags** | `graph`, `analytics`, `stats`, `comparison`, `data`, `chart-bar` |
