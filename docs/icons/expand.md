...
```html
<ss-icon icon="expand"></ss-icon>
```

### With icon tag

```html
<i class="ss ss-expand"></i>    
```

### With custom stroke width / thickness

```html
<ss-icon icon="expand" thickness="1.2"></ss-icon>
```
...
| **Name** | Expand |
| **Slug** | `expand` |
| **Tags** | `expand`, `large`, `grow`, `scale up`, `maximize` |
