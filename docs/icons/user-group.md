...
```html
<ss-icon name="user-group"></ss-icon>
```

### With custom size

```html
<ss-icon name="user-group" size="32"></ss-icon>
```

### With custom color

```html
<ss-icon name="user-group" color="#3b82f6"></ss-icon>
```

### With custom stroke width

```html
<ss-icon name="user-group" stroke="2"></ss-icon>
```
...
| **Name** | User Group |
| **Slug** | `user-group` |
| **Tags** | `people`, `team`, `community`, `audience`, `staff`, `members`, `user-group` |
