...
```html
<ss-icon icon="user-plus"></ss-icon>
```

### With icon tag

```html
<i class="ss ss-user-plus"></i>    
```

### With custom stroke width / thickness

```html
<ss-icon icon="user-plus" thickness="1.2"></ss-icon>
```
...
| **Name** | User Plus |
| **Slug** | `user-plus` |
| **Tags** | `add user`, `register`, `signup`, `new member`, `invite`, `friend`, `user-plus` |
