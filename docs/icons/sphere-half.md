...
```html
<ss-icon icon="sphere-half"></ss-icon>
```

### With icon tag

```html
<i class="ss ss-sphere-half"></i>    
```

### With custom stroke width / thickness

```html
<ss-icon icon="sphere-half" thickness="1.2"></ss-icon>
```
...
| **Name** | Sphere Half |
| **Slug** | `sphere-half` |
| **Tags** | `shape`, `hemisphere`, `3d`, `dome`, `half`, `round`, `sphere-half` |
