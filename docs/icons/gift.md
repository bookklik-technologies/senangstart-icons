...
```html
<ss-icon icon="gift"></ss-icon>
```

### With icon tag

```html
<i class="ss ss-gift"></i>    
```

### With custom stroke width / thickness

```html
<ss-icon icon="gift" thickness="1.2"></ss-icon>
```
...
| **Name** | Gift |
| **Slug** | `gift` |
| **Tags** | `present`, `reward`, `bonus`, `box`, `surprise`, `giveaway`, `gift` |
