...
```html
<ss-icon icon="truck"></ss-icon>
```

### With icon tag

```html
<i class="ss ss-truck"></i>    
```

### With custom stroke width / thickness

```html
<ss-icon icon="truck" thickness="1.2"></ss-icon>
```
...
| **Name** | Truck |
| **Slug** | `truck` |
| **Tags** | `delivery`, `shipping`, `transport`, `vehicle`, `logistics`, `lorry`, `truck` |
