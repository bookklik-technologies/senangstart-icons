...
```html
<ss-icon name="lock-open"></ss-icon>
```

### With custom size

```html
<ss-icon name="lock-open" size="32"></ss-icon>
```

### With custom color

```html
<ss-icon name="lock-open" color="#3b82f6"></ss-icon>
```

### With custom stroke width

```html
<ss-icon name="lock-open" stroke="2"></ss-icon>
```
...
| **Name** | Lock Open |
| **Slug** | `lock-open` |
| **Tags** | `unlock`, `public`, `access`, `insecure`, `logout`, `lock-open` |
...
<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
  <path d="M13.5 10.5V6.75a4.5 4.5 0 119 0v3.75M3.75 21.75h10.5a2.25 2.25 0 002.25-2.25v-6.75a2.25 2.25 0 00-2.25-2.25H3.75a2.25 2.25 0 00-2.25 2.25v6.75a2.25 2.25 0 002.25 2.25z"></path>
</svg>
```
